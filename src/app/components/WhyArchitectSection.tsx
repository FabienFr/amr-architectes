  ...
  const reasons = [
    {
      ...
      content:
        "L'architecte commence par écouter attentivement vos attentes, vos goûts et votre mode de vie. Il vous aide à définir un programme adapté, en tenant compte de l'évolution possible de votre famille et de vos besoins futurs.",
    },
    {
      title: "Conception sur mesure",
      content:
        "Fort de cette compréhension, l'architecte conçoit un projet personnalisé qui optimise l'utilisation de l'espace, respecte le caractère du bâtiment existant et s'intègre harmonieusement dans son environnement.",
    },
    {
    ...
    },
    {
      ...
      content:
        "En tant que maître d'œuvre, l'architecte coordonne les différents professionnels impliqués dans le projet (ingénieurs, entrepreneurs, artisans), assurant ainsi une exécution fluide et conforme aux plans établis.",
    },
    {
    ...
    },
    {
      ...
      content:
        "Faire appel à un architecte vous offre des garanties professionnelles, telles que l'assurance décennale, protégeant votre investissement sur le long terme.",
    },
  ];
