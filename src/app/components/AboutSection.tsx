          ...
          <div className="md:w-2/3">
            <div className="mb-8">
              <h2 className="font-norwester text-5xl md:text-6xl mb-3 flex flex-col items-start">
                <span className="text-2xl italic text-white mb-2">
                  Qui sommes
                </span>
                <span className="font-norwester text-gradient bg-gradient-to-r from-purple-300 to-purple-500 bg-clip-text text-transparent">
                  NOUS?
                </span>
              </h2>
            </div>
            ...
            <h3 className="text-2xl font-norwester mb-6 text-white">
              Une agence engagée et indépendante
            </h3>

            <div className="space-y-6 text-lg">
              <p className="leading-relaxed">
                Fondée par Michaël, architecte DPLG certifié DDQE, AMR
                accompagne particuliers, investisseurs et collectivités sur des
                projets à impact, entre Bordeaux et la côte basque.
              </p>

              <p className="leading-relaxed">
                Notre approche : des conceptions durables, une écoute attentive,
                et une mise en œuvre cadrée à chaque étape – de la recherche de
                terrain jusqu&apos;au chantier.
              </p>
            </div>
          </div>
