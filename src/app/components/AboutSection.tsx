          ...
          <div className="md:w-2/3">
            <div className="mb-8">
              <h2 className="font-norwester text-5xl md:text-6xl mb-3 flex flex-col items-start">
                ...
                <span className="font-norwester text-gradient bg-gradient-to-r from-purple-300 to-purple-500 bg-clip-text text-transparent">NOUS?</span>
              </h2>
            </div>

            <h3 className="text-2xl font-norwester mb-6 text-white">Une vision engagée de l&apos;architecture</h3>

            <div className="space-y-6 text-lg">
              <p className="leading-relaxed">AMR Architectes, fondé par Michaël, architecte D.E.H.M.O.N.P. certifié DDQE, accompagne les particuliers, investisseurs, collectivités et agences dans leurs projets à impact.</p>

              <p className="leading-relaxed">De Biarritz à Bordeaux, nous mettons l&apos;architecture au service du territoire, du climat et de l&apos;humain.</p>
            </div>
          </div>

          {/* Colonne de droite - Illustration/Image */}
