        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          <div className="md:w-2/3">
            ...
            <h3 className="text-2xl font-norwester mb-6 text-white">
              Une vision engagée de l&apos;architecture
            </h3>

            <div className="space-y-6 text-lg">
              <p className="leading-relaxed">
                AMR Architectes, fondé par Michaël, architecte D.E.H.M.O.N.P.
                certifié DDQE, accompagne les particuliers, investisseurs,
                collectivités et agences dans leurs projets à impact.
              </p>

              <p className="leading-relaxed">
                De Biarritz à Bordeaux, nous mettons l&apos;architecture au
                service du territoire, du climat et de l&apos;humain.
              </p>
            </div>
          </div>
