  ...
  const feasibilityLevels = [
    {
      ...
      features: ["Entretien & conseil initial", "Visite de site", "Analyse du PLU et des gabarits (orale)", "Intégration environnementale", "Estimation des surfaces"],
    ...
    },
    {
      ...
      features: ["Entretien & conseil initial", "Visite de site", "Analyse du PLU et des gabarits", "Vérification du bâti existant", "Relevé ou modélisation", "Esquisse ou options d'implantation", "Intégration environnementale", "Estimation des surfaces", "Dossier graphique PDF remis"],
    ...
    },
    {
      ...
      features: ["Tous les services de l'étude avancée", "Estimation budgétaire des travaux", "Aide à la stratégie foncière et patrimoniale", "Dossier complet pour présentation aux services d'urbanisme"],
