  ...
  return (
    <section className="py-24 bg-black text-white px-6">
      <div className="max-w-6xl mx-auto">
        <h2 className="font-norwester text-4xl md:text-5xl text-center mb-6 text-white">COMMENCER UNE ÉTUDE DE FAISABILITÉ</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          {feasibilityLevels.map((level, index) => (
            <div key={index} className="border border-gray-800 bg-white overflow-hidden rounded-xl">
              ...
              {/* Images placeholder - replace with actual images */}
