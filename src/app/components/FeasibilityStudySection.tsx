  ...
  return (
    <section className="py-24 bg-black text-white px-6">
      <div className="max-w-6xl mx-auto">
        <h2 className="font-norwester text-4xl md:text-5xl text-center mb-6 text-white">
          COMMENCER UNE ÉTUDE DE FAISABILITÉ
        </h2>

        <p className="text-center text-gray-300 mb-16 max-w-3xl mx-auto">
          Travailler avec un architecte c&apos;est une question de relation, car
          lorsque les études de faisabilité amènent un projet jusqu&apos;au
          bout, cela nous embarque ensemble pour plusieurs mois d&apos;une
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          {feasibilityLevels.map((level, index) => (
            ...
            >
              ...
              <div className="p-4">
                <p className="font-norwester text-black mb-4">
                  {level.description}
                </p>
